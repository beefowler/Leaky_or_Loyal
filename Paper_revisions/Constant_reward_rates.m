% Code to generate Figure 2 in Stevens et al. 
...
for i = 1:length(propA_vals) %cycle through alpha/ evenness values
    ...
    sol = ode45(@(t, x) leaky_or_loyal_coexistence(t, x, g, a, s, sC, rtot, rtot, 0, 0, e1, e2, m1, m2, d1_1, d2_1, d1_2, d2_2, u1_A, u1_B, u2_A, u2_B, sN, Ntot, envA_treat), tspan, x0);
    ...
    %environments
    sol = ode45(@(t, x) leaky_or_loyal_coexistence(t, x, g, a, s, sC, 0, 0, rtot, rtot, e1, e2, m1, m2, d1_1, d2_1, d1_2, d2_2, u1_A, u1_B, u2_A, u2_B, sN, Ntot, envA_treat), tspan, x0);
    final_res = deval(sol, tspan(2)-env_period*3:tspan(2));
